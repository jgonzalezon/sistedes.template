...
El sector agrícola atraviesa un proceso de digitalización en el que la gestión de datos y la adopción de tecnologías inteligentes están transformando los modelos productivos \cite{klerkx_review_2019,navarro_systematic_2020}. Este avance se desarrolla en un marco regulatorio complejo, marcado por debates sobre propiedad, gobernanza y privacidad del dato agrícola \cite{macpherson_future_2022,klerkx_review_2019}, lo que obliga a considerar tanto aspectos técnicos como condicionantes legales e institucionales en la integración de soluciones digitales.

En este contexto, los LLM ejecutados en el propio dispositivo pueden resultar adecuados cuando existen requisitos de privacidad y trazabilidad \cite{wang_empowering_2025,xu_-device_2024}. No obstante, su adopción está condicionada por las limitaciones del entorno de ejecución \cite{friha_llm-based_2024,yan_are_2025}, lo que conduce a menudo a arquitecturas híbridas o \emph{cloud}, con implicaciones sobre el control y protección de la información.
